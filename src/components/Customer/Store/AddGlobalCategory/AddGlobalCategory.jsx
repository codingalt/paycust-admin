...
import { useAddGlobalCategoryMutation } from "@/services/api/customer/store/storeCategoriesApi";
...
const AddGlobalCategory = () => {
  ...
  const [addGlobalCategory, res] = useAddGlobalCategoryMutation();
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    await addGlobalCategory(formData);
